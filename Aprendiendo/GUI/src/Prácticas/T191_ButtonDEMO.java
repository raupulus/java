...
public class T191_ButtonDEMO extends JPanel
  implements ActionListener {

    protected JButton b1, b2, b3;

    public T191_ButtonDEMO() {
    ...
    protected static ImageIcon createImageIcon(String path) {
        java.net.URL imgURL = T191_ButtonDEMO.class.getResource(path);
        if (imgURL != null) {
    ...
    private static void createAndShowGUI() {
        ...
        T191_ButtonDEMO newContentPane = new T191_ButtonDEMO();
